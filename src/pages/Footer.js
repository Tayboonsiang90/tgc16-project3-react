    ...
    return (
        <section className="bg-light overflow-hidden">
            <div className="row">
                <div className="col-12 col-md-5 col-lg-3 py-20 px-6 bg-white">
                    <div className="mw-xs mx-auto">
                        ...
                        <div className="d-flex mb-16 mb-md-40">
                            ...
                            <div className="d-inline-block" href="#">
                                {/* Twitter Logo */}
                                <svg width="50" height="50" viewBox="0 0 50 50" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className="col-12 col-md-7 col-lg-9 py-20 px-6 ps-lg-40">
                    <div className="row pb-20 border-bottom">
                        <div className="col-12 col-md-6 col-lg-4 mb-10 mb-lg-0">
                            <h6 className="mb-8">Information</h6>
